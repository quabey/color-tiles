...
<nav class="border-gray-200 dark:bg-gray-900 dark:border-gray-700">
	...
	>
		...
		<div class="">
			<div
				class="flex flex-col space-y-2 px-4 justify-center items-center"
			>
		...
		<div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
			...
			>
				<Button
					...
					color="light"
					id="avatar_menu"
					class="!p-1 transition hover:scale-125 z-[100]"
				>
					<Avatar src={$profileImg} class="me-2" />
